...
const useData = (behandlinger: Behandling[]) => {
  ...
  return useMemo(() => {
    ...
    const filteredForSakstyper =
      sakstyper.length === 0 ? filteredForAvsluttet : filteredForAvsluttet.filter((b) => sakstyper.includes(b.typeId));
  ...
  }, [behandlinger, ytelser, klageenheter, hjemler, avsluttet, ledige, sakstyper]);
};
