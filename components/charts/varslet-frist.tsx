...
const getExceededFrist = (b: FristBehandling) => {
  if (b.varsletFrist === null) {
    return ExceededFrist.NULL;
  }

  if (isFerdigstilt(b)) {
    return isAfter(new Date(b.avsluttetAvSaksbehandlerDate), new Date(b.varsletFrist))
      ? ExceededFrist.EXCEEDED
      : ExceededFrist.NOT_EXCEEDED;
  }

  return isAfter(TODAY, new Date(b.varsletFrist)) ? ExceededFrist.EXCEEDED : ExceededFrist.NOT_EXCEEDED;
};
